# mmStopWatch 1.7.0 — stable Slint release

## Scope

`v1.7.0` is the first stable release of the standalone Slint application. The former browser/Tauri implementation is not part of this release and is no longer built by CI.
