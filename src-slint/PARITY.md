...
| Goals/calendar | Daily target, streak, consistency and heat calendar | Partial (current-month calendar complete, month navigation pending) | Goal and date-boundary fixtures match |
