...
| Timer table | Sortable table mode and persisted order | Missing | Mode/order survive restart and match card data |
...
| Reports | Weekly/monthly Markdown reports and export workflow | Missing | Golden report output matches |
...
| Notifications | Periodic reminder, estimate limit alert, overlay and custom sound | Missing | Enabled/disabled paths and one-shot expiry are tested |
