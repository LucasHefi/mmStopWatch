...
const TOOL_NAMES_BY_COMMAND: Record<string, string[]> = {
  ...
  profile_list: ['mmstopwatch_profile_list'],
  config_get: ['mmstopwatch_config_get'],
  notification_status: ['mmstopwatch_notification_status'],
...
const TOOL_ROUTES: Record<string, ToolRoute> = {
  ...
  mmstopwatch_profile_list: { method: 'GET', path: '/api/v1/profiles' },
  mmstopwatch_config_get: { method: 'GET', path: '/api/v1/config' },
  mmstopwatch_notification_status: { method: 'GET', path: '/api/v1/notifications' },
